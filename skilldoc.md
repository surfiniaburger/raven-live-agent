RAVEN Doc Map (Skills Alignment)

Companion references:
- design.md for agentic design patterns and selection criteria
- eleven.md for ElevenLabs STT/TTS realtime fallback
- stream.md to stream4.md for ADK Live API streaming integration

Skills should reflect the live agent primary flow and the fallback voice path
when Live API is blocked (policy 1008), without changing tool contracts.
...
Experimental
The Skills feature is experimental and has some known limitations. We welcome your feedback!
...
The following directory structure shows the recommended way to include Skills in your ADK agent project. The example_skill/ directory shown below, and any parallel Skill directories, must follow the Agent Skill specification file structure. Only the SKILL.md file is required.
...
ADK Skills agent code sample: skills_agent.
Agent Skills specification documentation
 Back to top
Previous
Tool limitations
Next
